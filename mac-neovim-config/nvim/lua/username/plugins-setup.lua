...
return packer.startup(function(use)
	...
	use("bluz71/vim-nightfly-guicolors") -- prefereed colorscheme
	...
	-- essential plugins
	use("tpope/vim-surround") -- `ysw<character` surround with word with letters,
	--`csw<oldcharacter><newcharacter` change character surrounding word, change ch `dsw<characterdelete charater around word

	use("vim-scripts/ReplaceWithRegister")

	-- commenting out gc
	use("numToStr/Comment.nvim") -- comment/uncomment with gc, gc<number of lines>j
	...
	use("nvim-treesitter/playground") -- bridges gap b/w mason & null-ls
	...
	-- git integration
	use("lewis6991/gitsigns.nvim") -- show line modifications on left side
...
-- run :PackerCompile in normal mode to install plugins
-- run :PackerStatus to show lists of installed plugins
