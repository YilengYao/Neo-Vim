...
local bundles = {
  vim.fn.glob(home .. "/.java/installs/java/com.microsoft.java.debug.plugin/target/com.microsoft.java.debug.plugin-0.48.0.jar")
}
...
local config = {
    ...
    java = {
      ...
      configuration = {
        runtimes = {
          {
            name = "JavaSE-17",
            path = home .. "/.java/installs/java/java-17-openjdk-amd64",
          },
          {
            name = "JavaSE-11",
            path = home .. "/.java/installs/java/java-11-openjdk-amd64",
          },
          {
            name = "JavaSE-1.8",
            path = home .. "/.java/installs/java/java-1.8.0-openjdk-amd64"
          },
        }
      }
    }
  ...
  cmd = {
    home .. "/.java/installs/java/java-17-openjdk-amd64/bin/java",
    ...
    '-jar',
    vim.fn.glob(home .. '/.java/installs/java/eclipse.jdt.ls/org.eclipse.jdt.ls.product/target/repository/plugins/org.eclipse.equinox.launcher_1.6.500.v20230717-2134.jar'),

    -- The configuration for jdtls is also placed where jdtls was installed. This will
    -- need to be updated depending on your environment
    '-configuration',
    home .. '/.java/installs/java/eclipse.jdt.ls/org.eclipse.jdt.ls.product/target/repository/config_linux',
