...
return packer.startup(function(use)
  ...
  use("saadparwaiz1/cmp_luasnip") -- for autocompletion, allow nvim-cmp to show snippet for completion
  use("rafamadriz/friendly-snippets") -- useful snippets

  -- managing & installing lsp servers, linters & formatters configure mason lsp server with :Mason
  use("williamboman/mason.nvim") -- in charge of managing lsp servers, linters & formatters
  use("williamboman/mason-lspconfig.nvim") -- bridges gap b/w mason & lspconfig

  -- configuring lsp servers
  use("neovim/nvim-lspconfig") -- easily configure language servers
  use("hrsh7th/cmp-nvim-lsp") -- allow lsp server appear in autocompletion
  use({
